...
app.use(cors({
  origin: [
    'https://jasonhollidaymagic.de',
    'https://www.jasonhollidaymagic.de',
    'https://jasonhollidaymagic.up.railway.app'
  ],
  methods: ['GET', 'POST'],
}));
...
app.post('/send-email', async (req, res) => {
  ...
  const mailOptions = {
    ...
    html: `<p>Du hast eine neue Anfrage erhalten:</p>
    <p>${message}</p><hr>
    <p>Von: <strong>${name}</strong> (${email})</p>
    <p>Telefon: ${phone} </p>
    `,
  };
